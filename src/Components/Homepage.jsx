  ...
  return (
    <div className="homepage">
      <div className="wrapper">
        ...
        <p>
          Our application allows you to quickly view a wide range of interesting
          <b> metrics</b> To get started, simply select a <b>button</b>
        </p>
        <p>
          Using the map you can directly locate a point of interest and see what
          is happening Any notable points are marked on the map
        </p>
        <svg
